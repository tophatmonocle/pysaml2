...
import saml2_tophat.attributemaps as attributemaps

from saml2_tophat.mdstore import destinations
from saml2_tophat.profile import paos, ecp
from saml2_tophat.saml import NAMEID_FORMAT_TRANSIENT
from saml2_tophat.samlp import AuthnQuery, RequestedAuthnContext
...
from saml2_tophat.extension import sp_type
from saml2_tophat.extension import requested_attributes
...
from saml2_tophat.s_utils import signature
from saml2_tophat.s_utils import UnravelError
from saml2_tophat.s_utils import do_attributes

from saml2_tophat import samlp, BINDING_SOAP, SAMLError
from saml2_tophat import saml
from saml2_tophat import soap
from saml2_tophat.population import Population

from saml2_tophat.response import AttributeResponse, StatusError
from saml2_tophat.response import AuthzResponse
from saml2_tophat.response import AssertionIDResponse
from saml2_tophat.response import AuthnQueryResponse
from saml2_tophat.response import NameIDMappingResponse
...
class Base(Entity):
    ...
    def create_authn_request(self, destination, vorg="", scoping=None,
                             binding=saml2_tophat.BINDING_HTTP_POST,
                             nameid_format=None,
